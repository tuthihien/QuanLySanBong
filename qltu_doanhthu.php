        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="#"><i class="fa fa-fw fa-glass"></i> Quan ly thuc uong</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Quan ly thuc uong
                            </li>
                        </ol>
                        <ul class="nav nav-tabs">
                            <li><a href="qltu_nhapthucuong.php">Nhap thuc uong</a></li>
                            <li><a href="qltu_banthucuong.php">Ban thuc uong</a></li>
                            <li class="active"><a href="qltu_doanhthu.php">Doanh thu</a></li>
                        </ul>                        
                    </div>
                </div>
                <!-- /.row -->
