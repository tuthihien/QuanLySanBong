...
<head>
    ...
    <title>QLSB - Ban thuc uong</title>
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul class="nav nav-tabs">
                            <li><a href="qltu_nhapthucuong.php">Nhập thức uống</a></li>
                            <li class="active"><a href="qltu_banthucuong.php">Bán thức uống</a></li>
    ...
    <div class="modal fade" id="add-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            ...
            <h1>Them/Sua thuc uong</h1><sub>chua viet xong</sub><br>
          <form>
